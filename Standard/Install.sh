...
adduser l4d2
echo "YOURPASSWORDHERE" | passwd --stdin l4d2
...
#/L4D2/Server/srcds_run -game left4dead2 +exec server.cfg +port 27020 +maxplayers 8 -tickrate 100 -pingboost 2 +map c1m1_hotel > /dev/null 2>&1 &